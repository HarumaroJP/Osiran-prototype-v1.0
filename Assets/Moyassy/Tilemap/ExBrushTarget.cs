...
namespace Moyassy {
    ...
    public enum ExBrushTargetType {
        Tilemap,
        ForPrefabBrush,
        ManualObjects
    }

    public enum ExBrushTargetConditionMode {
        RejectByLabels,
        AcceptByLabels
    }
    ...
    public class ExBrushTarget : MonoBehaviour {
        ...
        public bool TilemapTarget {
            get { return type == ExBrushTargetType.Tilemap; }
        }

        public bool ObjectsTarget {
            get { return type == ExBrushTargetType.ForPrefabBrush || type == ExBrushTargetType.ManualObjects; }
        }
        ...
        bool IsAcceptedCore(Object o) {
            ...
            // Objectのラベル一覧を取得する
            IEnumerable<string> assetLabels = new List<string>(UnityEditor.AssetDatabase.GetLabels(o));
